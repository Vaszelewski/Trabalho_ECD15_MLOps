...
client = MlflowClient(tracking_uri="sqlite:///mlflowXg.db")
model_name = "XGBoostGridSearch"

# Definir os limites de F1-score para Staging e Production
staging_threshold = 0.065  # Apenas modelos acima deste F1-score vão para Staging
