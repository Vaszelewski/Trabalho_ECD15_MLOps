...
def train_xgboost_grid_search(X, y, dataset_name, mlflow_dataset):
    ...
    with mlflow.start_run(run_name=f"RF_{params['n_estimators']}_{params['max_depth']}_{params['learning_rate']}"):
        ...
        model_info = mlflow.sklearn.log_model(xg, "xgboost_grid_search",
                                 signature=signature,
